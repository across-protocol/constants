...
export const TOKEN_SYMBOLS_MAP = {
  ...
  ETH: {
    ...
    addresses: {
      ...
      [CHAIN_IDs.PLASMA]: "0x9895D81bB462A195b4922ED7De0e3ACD007c32CB",
      ...
      [CHAIN_IDs.ROBINHOOD]: "0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73",
  ...
  USDC: {
    ...
    addresses: {
      ...
      [CHAIN_IDs.PLASMA]: "0x2d661C89D812261039AF9764eceaAee884f5F67F",
  ...
  USDT: {
    ...
    addresses: {
      ...
      [CHAIN_IDs.PLASMA_TESTNET]: "0x12adA0e58293017eA3e5e6c1C0976F0f162A411b",
      ...
      [CHAIN_IDs.SONEIUM]: "0x3A337a6adA9d885b6Ad95ec48F9b75f197b5AE35",
  ...
  XPL: {
    ...
    decimals: 18,
    addresses: {
      [CHAIN_IDs.PLASMA]: "0x6100E367285b01F48D07953803A2d8dCA5D19873",
      [CHAIN_IDs.PLASMA_TESTNET]: "0x6100E367285b01F48D07953803A2d8dCA5D19873",
    },
    coingeckoId: "plasma",
  },
  WAZERO: {
...
export const TOKEN_EQUIVALENCE_REMAPPING: { [symbol: string]: string } = {
  ...
  [TOKEN_SYMBOLS_MAP.USDG.symbol]: TOKEN_SYMBOLS_MAP.USDC.symbol,
