...
export const TESTNET_SEPOLIA_CHAIN_IDs = {
  ...
  ESPRESSO_DEMO_1: 10001,
  ESPRESSO_DEMO_2: 10002,
};
...
export const TOKEN_SYMBOLS_MAP = {
  ...
  ETH: {
    ...
    addresses: {
      ...
      [CHAIN_IDs.ESPRESSO_DEMO_1]: "0xeF684C38F94F48775959ECf2012D7E864ffb9dd4",
      [CHAIN_IDs.ESPRESSO_DEMO_2]: "0xeF684C38F94F48775959ECf2012D7E864ffb9dd4",
    },
  },
  MATIC: {
    name: "Matic",
